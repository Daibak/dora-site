                ...
                <section id="three" class="wrapper spotlight style3">
                    <div class="inner">
                        ...
                        <div class="content">
                            ...
                            <a href="competenze/contrattualistica.html" class="special">Dettagli</a>
                        </div>
                    </div>
                </section>
                ...
                <section id="three" class="wrapper spotlight style5">
                    <div class="inner">
                        ...
                        <div class="content">
                            ...
                            <a href="competenze/recupero-credito.html" class="special">Dettagli</a>
                        </div>
                    </div>
                </section>
                    ...
                    <div id="about" class="inner">
                        ...
                        <section class="features">
                            <article>
                                ...
                                <a href="#" class="special">Dettagli</a>
                            </article>
                            <article>
